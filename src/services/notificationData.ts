...
export const SAMPLE_RENT_LEASE_NOTIFICATIONS: RentLeaseNotification[] = [
  ...
  {
    id: 'rent-05',
    title: 'Boat Club Road Waterfront Bungalow',
    propertyType: 'Villa',
    locality: 'RA Puram',
    city: 'Chennai',
    rentAmount: '₹2,10,000 / mo',
    depositAmount: '₹6 Lakhs',
    bhk: '5 BHK Colonial Estate',
    areaSqFt: 4200,
    furnished: 'Fully Furnished',
    isNew: true,
  ...
  {
    id: 'rent-06',
    title: 'Lutyens Heritage Residence',
    propertyType: 'Penthouse',
    locality: 'Jor Bagh',
    city: 'Delhi',
    rentAmount: '₹3,50,000 / mo',
    depositAmount: '₹10 Lakhs',
    bhk: '4 BHK Luxury',
    areaSqFt: 3900,
    furnished: 'Fully Furnished',
    isNew: true,
  ...
  {
    id: 'rent-07',
    title: 'Koregaon Park Green Manor',
    propertyType: 'Villa',
    locality: 'Lane 1, Koregaon Park',
    city: 'Pune',
    rentAmount: '₹1,30,000 / mo',
    depositAmount: '₹3.5 Lakhs',
    bhk: '4 BHK Garden Villa',
    areaSqFt: 3400,
    furnished: 'Fully Furnished',
    isNew: false,
  ...
  {
    id: 'rent-08',
    title: 'Candolim Sunset Beachside Villa',
    propertyType: 'Villa',
    locality: 'Candolim Coastline',
    city: 'Goa',
    rentAmount: '₹1,80,000 / mo',
    depositAmount: '₹4.5 Lakhs',
    bhk: '3 BHK Oceanfront',
    areaSqFt: 2900,
    furnished: 'Fully Furnished',
    isNew: true,
    postedAt: '1 hour ago',
